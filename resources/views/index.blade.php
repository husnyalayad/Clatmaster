...
<!--					<svg class="inline lqd-split-text-words transition-all duration-[2850ms]" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" -->
<!--	 width="64px" height="64px" viewBox="0 0 48 48" xml:space="preserve">-->
<!--<g>-->
...
<!--</svg>-->
			...
			<div class="transition-all delay-[450ms] opacity-0 translate-y-3 group-[.page-loaded]/body:opacity-100 group-[.page-loaded]/body:translate-y-0">
				@if ($fSetting->hero_button_type == 1)
					<x-button target="_blank" link="{{!empty($fSetting->hero_button_url) ? $fSetting->hero_button_url : '#'}}" label="View Our Plans" size="lg">
						<x-slot name="icon">
						    	<svg class="!me-2" fill="#f05941" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
		...
		l7.125-3.228l-7.125-3.228v-2.15L37.58,28.6v1.883l-9.276,4.437V32.768z M25.21,22.146h1.881L22.924,36.8h-1.882L25.21,22.146z
		 M10.42,28.6l9.278-4.572v2.285l-6.992,3.229l6.992,3.227v2.151l-9.278-4.571V28.6z M44.975,18.285V29.58h-3.093V18.285H44.975z"/>
			...
			<div class="transition-all delay-[500ms] opacity-0 translate-y-3 group-[.page-loaded]/body:opacity-100 group-[.page-loaded]/body:translate-y-0">
				<a href="#features" class="hover:opacity-100 transition-opacity opacity-50">Discover Clat Master</a>
			</div>
		</div>
	</div>
	<div class="banner-divider absolute -bottom-[2px] inset-x-0">
    <svg class="fill-body-bg w-full h-auto wave-bottom" width="1440" height="105" viewBox="0 0 1440 105" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
        <path d="M0 0C90 40 200 80 300 75C400 70 500 30 600 45C700 60 800 90 900 80C1000 70 1100 20 1200 35C1300 50 1400 85 1440 0V104.113H0V0Z"/>
    </svg>
</div>
<style>
@keyframes wave-animation-bottom {
  0% {
    d: path("M0 0C90 40 200 80 300 75C400 70 500 30 600 45C700 60 800 90 900 80C1000 70 1100 20 1200 35C1300 50 1400 85 1440 0V104.113H0V0Z");
  }
  50% {
    d: path("M0 0C90 35 200 75 300 70C400 65 500 25 600 40C700 55 800 85 900 75C1000 65 1100 15 1200 30C1300 45 1400 80 1440 0V104.113H0V0Z");
  }
  100% {
    d: path("M0 0C90 40 200 80 300 75C400 70 500 30 600 45C700 60 800 90 900 80C1000 70 1100 20 1200 35C1300 50 1400 85 1440 0V104.113H0V0Z");
  }
...
.wave-bottom path {
  animation: wave-animation-bottom 4s infinite ease-in-out;
}
</style>

<!--<div class="banner-divider absolute inset-x-0" style="bottom: -20px;">-->
    ...
    <!--</svg>-->
<!--    <svg class="fill-body-bg w-full h-auto" width="1440" height="150" viewBox="0 0 1440 250" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style="margin-top: 20px;">-->
<!--        <path d="M0,256L34.3,250.7C68.6,245,137,235,206,202.7C274.3,171,343,117,411,85.3C480,53,549,43,617,69.3C685.7,96,754,160,823,192C891.4,224,960,224,1029,229.3C1097.1,235,1166,245,1234,229.3C1302.9,213,1371,171,1406,149.3L1440,128L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path>-->
<!--    </svg>-->
<!--</div>-->
...
<section class="site-section py-10 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0" id="how-it-works">
	<div class="container">
		<div class="p-10 py-24 bg-[#010101] rounded-[50px] shadow-xl text-white text-opacity-60 max-sm:px-5 bg-cover" style="background-image: url(/assets/img/site/bg23.jpg);">
...
<section class="site-section relative py-10 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0" id="testimonials">
	...
	<div class="container relative">
		<div class="p-11 pb-24 border rounded-[50px] bg-contain bg-center bg-no-repeat max-sm:px-5" style="background-image: url(/assets/img/site/worldmap1.png)">
			<x-section-header
				width="w-1/2"
				mb="10"
...
<!--<div class="opacity-80 max-lg:gap-12 max-sm:gap-4 flex justify-center gap-20">-->
    <!--@foreach($clients as $entry)-->
<!--        <img class="object-cover object-center w-full h-full" style="max-width: 480px; max-height: 408px;" -->
<!--            src="{{ url('public/assets/img/envato/1c.png') }}" -->
<!--             >-->
    <!--@endforeach-->
<!--</div>-->
