...
<div class="page page-auth page-register">
	...
	<div class="container-fluid">
		<div class="row items-stretch min-h-[100vh] max-lg:pt-32 max-lg:pb-20">
			...
			<div class="flex flex-col justify-center overflow-hidden bg-center bg-cover col-lg-6 max-lg:hidden" style="background-image: url(/images/bg/bgauth.png)">
				<img src="/images/bg/dash.png" alt="MagicAI Dashboard Mockup" class="rounded-[36px] shadow-[0_24px_88px_rgba(0,0,0,0.55)] translate-x-[27%]">
			</div>
		</div>
	</div>
</div>
